...
from utils.perspective import perspective_correction_with_buffer
...
def main():
    ...
    try:
        ...
        # -----------------------------
        warped, _ = perspective_correction_with_buffer(
            rotated_img, corners, rows, cols
        )
        ...
        boxes, vis = run_yolo_objects(
            model_path="hotpepper_models/best.pt",
            img=warped,
            conf_thr=0.30,
            green_thr=0.02,
            iou_thr=0.5,
        ...
        # -----------------------------
        from utils.box_grid_assignment import assign_boxes_to_grid
        ...
        # Classification
        # -----------------------------
        from utils.classification_processor import classify_shifted_image
        from tensorflow.keras.models import load_model

        cnn_model = load_model("hotpepper_models/HP_3class_germination_cnn.h5", compile=False)
