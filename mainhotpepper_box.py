...
def main():
    ...
    try:
        ...
        # -----------------------------
        from utils.box_grid_assignment_improved import assign_boxes_to_grid
        ...
        cnn_model = load_model("hotpepper_models/HP_3class_hybrid_germination_cnn.h5", compile=False)
